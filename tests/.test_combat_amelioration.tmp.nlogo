...
to setup
  ...
  create-humans population [
    ...
    set strength (random max-strength)
...
to attack
  ...
  ifelse any? other humans with [groupId != myGroupId] in-radius vision [
    ...
    ifelse one-of other humans-here with [groupId != myGroupId] != nobody [
      ...
      ask target [set targetStrength strength]
...
"" ""
PENS
"humans1" 1.0 0 -10899396 true "" "plot count humans with [groupId = 1]"
